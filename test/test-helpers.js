    ...
    trx
      ...
      .then(() =>
        Promise.all([
          ...
          trx.raw(
            `ALTER SEQUENCE expensity_users_id_seq minvalue 0 START WITH 1`
          ),
          trx.raw(`SELECT setval('expense_logs_id_seq', 0)`),
          trx.raw(`SELECT setval('expensity_users_id_seq', 0)`),
        ])
      )
  );
}
...
function seedUsers(db, users) {
  ...
  return db
    ...
    .then(() =>
      ...
      db.raw(`SELECT setval('expensity_users_id_seq', ?)`, [
